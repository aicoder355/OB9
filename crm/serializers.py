...
class ClientSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Client
        fields = ['id', 'name', 'phone', 'telegram_chat_id', 'telegram_username', 'address', 'apartment', 'floor', 'entrance', 'notes', 'registration_date', 'region']
...
class DriverSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Driver
        fields = ['id', 'name', 'phone', 'telegram_chat_id', 'telegram_verified', 'created_at', 'region']
